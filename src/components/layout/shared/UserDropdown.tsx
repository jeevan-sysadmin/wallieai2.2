...
// Import useSettings hook from appropriate location
import { useSettings } from '@core/hooks/useSettings' // Adjust path as per your project structure
...
const UserDropdown = () => {
  ...
  const [user, setUser] = useState<any>(null) // Type this based on your Firebase user data structure
  ...
  const { settings } = useSettings() // Use the useSettings hook here
