  ...
  return (
    ...
    >
      <p>
        ...
        <Link href='https://igclout.com/' target='_blank' className='text-primary uppercase'>
          Igclout
        </Link>
      </p>
      {!isBreakpointReached && (
        <div className='flex items-center gap-4'>
          <Link href='https://igclout.com/' target='_blank' className='text-primary'>
            License
          </Link>
          <Link href='https://igclout.com/' target='_blank' className='text-primary'>
            More Themes
